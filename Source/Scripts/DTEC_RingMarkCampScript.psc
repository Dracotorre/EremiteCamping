Scriptname DTEC_RingMarkCampScript extends ObjectReference  


; by DracoTorre
; requires Campfire DevKit CampUtil 
;
; using books instead - see DTEC_BookMarkCampScript
; ring used during testing and remains so player could use console to get rings for full function
...
Event OnEquipped(Actor akActor)
	if (akActor == PlayerREF && DTEC_SettingEnabled != None && DTEC_SettingEnabled.GetValue() >= 1.0 && DTEC_MarkCampQuest != None)
